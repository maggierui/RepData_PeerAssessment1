...
dat_imput$weekday[dat_imput$weekday %in% c('Monday','Tuesday','Wednesday','Thursday','Friday')]<-'Yes'
dat_imput$weekday[dat_imput$weekday %in% c('Saturday','Sunday')]<-'No'
by_interval_imput<-group_by(dat_imput,interval,weekday)
avg_by_intv_imput<-summarise(by_interval_imput, steps=mean(steps))
library(lattice)
